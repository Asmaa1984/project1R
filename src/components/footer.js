            ...
            <div className="container-lg">
                <div className="row my-2">
                    ...
                    <div className="social-icon col-12 d-flex justify-content-center ">
                        <a className="me-2" href="https://linkidin.com"><img src={Icon1} alt="icon" /></a>
                        <a className="me-2" href="https://facebook.com"><img src={Icon2} alt="icon" /></a>
                        <a className="me-2" href="https://instagram.com"><img src={Icon3} alt="icon" /></a>
